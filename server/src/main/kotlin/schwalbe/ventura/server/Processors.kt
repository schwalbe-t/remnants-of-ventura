...
val PROCESSOR_INFO: Map<ItemType, ProcessorInfo> = mapOf(
    ...
    ItemType.BIGTON_1030 to ProcessorInfo(BIGTON_2000_FEATURES, BIGTON_STATS_1),
    ItemType.BIGTON_1050 to ProcessorInfo(BIGTON_2000_FEATURES, BIGTON_STATS_2),
    ItemType.BIGTON_1070 to ProcessorInfo(BIGTON_2000_FEATURES, BIGTON_STATS_3),

    ItemType.BIGTON_1030 to ProcessorInfo(BIGTON_3000_FEATURES, BIGTON_STATS_2),
    ItemType.BIGTON_1050 to ProcessorInfo(BIGTON_3000_FEATURES, BIGTON_STATS_3),
    ItemType.BIGTON_1070 to ProcessorInfo(BIGTON_3000_FEATURES, BIGTON_STATS_4)
)