...
enum class LocalKeys {
    ...
    DESCRIPTION_SHOW_CONTROLS,
    SETTING_SHOW_CHAT,
    DESCRIPTION_SHOW_CHAT,
    ...
    TITLE_PURCHASE,
    BUTTON_PURCHASE,
    TOAST_PURCHASE_SUCCESSFUL,
    TITLE_SELL,
    BUTTON_SELL,
    TOAST_SALE_SUCCESSFUL,
    ...
    ERROR_NO_SPACE_FOR_ROBOT,
    ERROR_NOT_IN_MAINTENANCE_AREA,
    ERROR_STOPPED_DURING_CHALLENGE,
    ERROR_NOT_ENOUGH_COINS,
    ERROR_SOLD_ITEM_NOT_IN_INVENTORY
}
